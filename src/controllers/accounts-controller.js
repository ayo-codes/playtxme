...
export const accountsController = {
  ...
  signup: {
    auth: false,
    validate: {
      payload: UserSpec, // this is the Joi spec we are using 
      options: {abortEarly : false}, // allows to see all errors 
  ...
  login: {
    auth: false,
    validate: {
      payload: UserCredentialsSpec, // this is the spec we are using
